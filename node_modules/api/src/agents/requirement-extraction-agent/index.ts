...
export class RequirementExtractionAgent {
  static async run(rawText: string, agentRunId?: string): Promise<ExtractedRequirement> {
    ...
    try {
      ...
      let min_trust_score: number | null = null;
      ...
      if (scoreMatch) {
        ...
        if (min_trust_score > 100) min_trust_score = null;
      }
...
export default RequirementExtractionAgent;
