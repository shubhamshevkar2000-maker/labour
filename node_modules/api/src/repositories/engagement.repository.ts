...
export class EngagementRepository {
  ...
  static createPriceOffer(data: {
    ...
    db.prepare(`
      INSERT INTO price_offers (id, engagement_id, offered_by, amount, note, material_included, estimated_duration, visit_date, created_at)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(
      id,
      data.engagement_id,
